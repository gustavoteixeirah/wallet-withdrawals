...
public class WalletWithdrawOperations {
    ...
    public WalletWithdraw create(Long userId, BigDecimal amount, Recipient recipient) {
        ...
        WalletWithdraw walletWithdraw = new WalletWithdraw(id, userId, amount, recipient);
